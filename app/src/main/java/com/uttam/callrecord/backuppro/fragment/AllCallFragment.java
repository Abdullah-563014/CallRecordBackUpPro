...
public class AllCallFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.allCallFragmentSpinKitId);
        return view;
    }
    ...
    private void showRecordExcessAlertDialog() {
        AlertDialog.Builder builder=new AlertDialog.Builder(getContext())
                .setCancelable(true)
                .setMessage(getResources().getString(R.string.record_excess_dialog_message))
