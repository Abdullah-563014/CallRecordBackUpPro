...
public class OutgoingCallFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.outgoing_call_fragment, container, false);
        recyclerView = view.findViewById(R.id.outgoingCallRecyclerViewId);
        progressBar = view.findViewById(R.id.outgoingCallFragmentSpinKitId);
        return view;
    }
                        ...
                        for (com.google.api.services.drive.model.File file : fileList.getFiles()){
                            ...
                            if (fileNameWithoutExtension.contains(",")){
                                ...
                                if (fileInfo.length==5){
                                    ...
                                    if (callIndicator.equalsIgnoreCase("outgoing")){
